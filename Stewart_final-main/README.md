...
## Due 12/2: Follow the below directions to start your final project template. Remember to have final.html open in a browser to see your changes taking place. Use the reference sheet and Google as a resource.  
...
TODO in-class: In the head of final.html, under the appropriate comment, add the Google font 'Poppins' to your project. (We haven't learned how to do this so don't worry about it for homework. We will go over in class after break.)   

To submit: Upload `final.html`, `final.css`, and `syr.png` to your own repository. Add to our 'github accounts' Google Doc: https://docs.google.com/document/d/1knwcANjSnEBluMi8eknHNwOyTmYYuuzD5g3TQqIqZzk/edit?tab=t.0.
